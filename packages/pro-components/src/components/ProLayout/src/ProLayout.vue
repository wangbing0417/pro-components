<template>
  <div class="pro-layout">
    <ProLayoutAside :routes="routes" :collapse="show" @toggle-collapse="toggleShow">
      <template #logo="{ collapse }">
        ...
        <template v-if="!$slots.logo">
          <svg viewBox="0 0 24 24" role="img" class="pro-logo-img">
            <path
          ...
          <span v-if="!show" class="pro-logo-title">{{ title }}</span>
        </template>
      </template>
    ...
    <div class="pro-layout-right">
      <ProLayoutHeader
        :collapse="show"
        @toggle-collapse="toggleShow"
        @handle-bell="$emit('handle-bell')"
        @logout="$emit('logout')"
      >
        <template #left>
      ...
      <div class="pro-layout-content">222</div>
    </div>
  </div>
</template>
